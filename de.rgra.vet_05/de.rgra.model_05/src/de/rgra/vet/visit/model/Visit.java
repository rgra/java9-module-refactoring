package de.rgra.vet.visit.model;
...
public class Visit {
	...
	private IntegerProperty foreignIdProperty = new SimpleIntegerProperty(this, "foreignId");
	...
	public IntegerProperty getForeignIdProperty() {
		return foreignIdProperty;
	}

	public int getForeignId() {
		return foreignIdProperty.get();
	}

	public void setForeignId(int value) {
		foreignIdProperty.set(value);
	}
