...
public class VetServicesApplication extends javafx.application.Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		primaryStage.getIcons().add(new Image(VetServicesApplication.class.getResource("vet_symbol.png").toString())); //$NON-NLS-1$
		...
		scene.getStylesheets().add(VetServicesApplication.class.getResource("test.css").toURI().toString()); //$NON-NLS-1$
