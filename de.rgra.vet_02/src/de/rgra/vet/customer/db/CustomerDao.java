...
public class CustomerDao {
	...
	private static List<StreetZip> readStreets() {
		...
		try {
			URL resourceAsStream = CustomerDao.class.getResource("streets.csv"); //$NON-NLS-1$

			List<String> streetLines = Files.readAllLines(Paths.get(resourceAsStream.toURI()), StandardCharsets.ISO_8859_1);
